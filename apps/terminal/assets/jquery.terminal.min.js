    ...
    $.fn.terminal = function (e, t) {
        ...
        function X(t, a, n) {
            ...
            if (e === "array") {
                ...
                (function t(e, n) {
                    ...
                    n({
                        interpreter: Y(o, false, a, l && l.bind(C)),
                ...
                n({
                    interpreter: Y(t, F.checkArity, a),
        ...
        function ke(y, b) {
            return function e(o, s) {
                ...
                if (b) {
                    var n = $.terminal.split_equal(l, C.cols(), {
                        keepWords: t,
                    });
                }
                Ve = true;
                ...
                if (p > 0) {
                    ...
                    if (b) {
                        var h = n.map(function (e) {
                            return {
                                formatted: e,
                                chars: $.terminal.partition(e, { wrap: false }),
                                len: $.terminal.length(e),
                            };
                        });
                    } else {
        ...
        var Me = $.omap(
            {
                ...
                import_view: function (t) {
                    if (y) {
                        throw new Error(
                            sprintf(c().notWhileLogin, "import_view")
                        );
                    }
                    v("onImport", [t]);
                    p(function e() {
                        ...
                        if (++qe >= 2) {
                            ...
                            if (i.echo) {
                                if (is_function(i.doubleTab)) {
                                    ...
                                    C.echo($.terminal.escape_brackets(D), {
                                        keepWords: true,
                                        formatters: false,
                                    });
                                }
                ...
                geometry: function () {
                    ...
                    return {
                        terminal: {
                            ...
                            width: nt + e.left + e.right,
                            height: rt + e.top + e.bottom,
                        },
                        density: O,
                        char: L,
                        cols: this.cols(),
                ...
                flush: function (d) {
                    ...
                    p(function e() {
                        try {
                            ...
                            var D = C.offset();
                            C.stopTime("flush").oneTime(
                                1,
                                "flush",
                                function () {
                                    css(C[0], {
                                        "--terminal-height": C.height(),
        ...
        var F = $.extend(
            {},
            $.terminal.defaults,
            { name: C.selector, exit: !!((t && t.login) || !t) },
            t || {}
        );
        ...
        X(e, F.login, function (e) {
            ...
            if (is_mobile) {
                ...
                r.on("focus.terminal_" + C.id(), Dt).on(
                    "blur.terminal_" + C.id(),
                    ht
                );
                var h;
                            ...
                            C.everyTime(20, "selection", function () {
                                if (D[0].selection !== D[0].value) {
                                    if (get_textarea_selection(D[0])) {
                                        ...
                                        select(
                                            C.find(".terminal-output")[0],
                                            C.find(".cmd div:last-of-type")[0]
                                        );
                                        C.stopTime("selection");
                                    }
                                }
